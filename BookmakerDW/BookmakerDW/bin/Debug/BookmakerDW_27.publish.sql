...
GO
PRINT N'Creating [dbo].[DimUserGroup]...';


GO
CREATE TABLE [dbo].[DimUserGroup] (
    [Id]        INT           IDENTITY (1, 1) NOT NULL,
...
GO
PRINT N'Creating [dbo].[DF_Is_Started_DimMatch]...';


GO
ALTER TABLE [dbo].[DimMatch]
    ADD CONSTRAINT [DF_Is_Started_DimMatch] DEFAULT 0 FOR [IsStarted];


GO
PRINT N'Creating [dbo].[DF_Is_Ended_DimMatch]...';


GO
ALTER TABLE [dbo].[DimMatch]
    ADD CONSTRAINT [DF_Is_Ended_DimMatch] DEFAULT 0 FOR [IsEnded];


GO
PRINT N'Creating [dbo].[DF_ScoreHomeTeam_DimMatch]...';


GO
ALTER TABLE [dbo].[DimMatch]
    ADD CONSTRAINT [DF_ScoreHomeTeam_DimMatch] DEFAULT 0 FOR [ScoreHomeTeam];


GO
PRINT N'Creating [dbo].[DF_ScoreAwayTeam_DimMatch]...';


GO
ALTER TABLE [dbo].[DimMatch]
    ADD CONSTRAINT [DF_ScoreAwayTeam_DimMatch] DEFAULT 0 FOR [ScoreAwayTeam];
...
GO
PRINT N'Creating [dbo].[DF_Created_At_DimUserGroups]...';


GO
ALTER TABLE [dbo].[DimUserGroup]
    ADD CONSTRAINT [DF_Created_At_DimUserGroups] DEFAULT GETDATE() FOR [CreatedAt];
...
GO
PRINT N'Creating [dbo].[FK_Match_FactFinance_DimMatch]...';


GO
ALTER TABLE [dbo].[FactFinance]
    ADD CONSTRAINT [FK_Match_FactFinance_DimMatch] FOREIGN KEY ([MatchId]) REFERENCES [dbo].[DimMatch] ([Id]);


GO
PRINT N'Creating [dbo].[FK_User_FactFinance_DimUser]...';


GO
ALTER TABLE [dbo].[FactFinance]
    ADD CONSTRAINT [FK_User_FactFinance_DimUser] FOREIGN KEY ([UserId]) REFERENCES [dbo].[DimUser] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Sport_FactFinance_DimUserGroup]...';


GO
ALTER TABLE [dbo].[FactFinance]
    ADD CONSTRAINT [FK_Sport_FactFinance_DimUserGroup] FOREIGN KEY ([UserGroupId]) REFERENCES [dbo].[DimUserGroup] ([Id]);
