...
IF EXISTS (select top 1 1 from [dbo].[DimMatch])
...
GO
PRINT N'Starting rebuilding table [dbo].[DimMatch]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_DimMatch] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[DimMatch])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_DimMatch] ON;
        INSERT INTO [dbo].[tmp_ms_xx_DimMatch] ([Id])
        SELECT   [Id]
        FROM     [dbo].[DimMatch]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_DimMatch] OFF;
    END

DROP TABLE [dbo].[DimMatch];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_DimMatch]', N'DimMatch';
