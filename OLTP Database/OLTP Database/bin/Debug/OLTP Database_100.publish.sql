...
GO
PRINT N'Creating [dbo].[Events_tmp]...';


GO
CREATE TABLE [dbo].[Events_tmp] (
    [Id]               INT            IDENTITY (1, 1) NOT NULL,
    [MatchId]          INT            NOT NULL,
...
GO
ALTER TABLE [dbo].[Bets]
    ADD CONSTRAINT [FK_Match_Bets_Events] FOREIGN KEY ([MatchId]) REFERENCES [dbo].[Events_tmp] ([Id]);
