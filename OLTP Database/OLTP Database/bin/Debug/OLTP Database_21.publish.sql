...
CREATE PROCEDURE [dbo].[UserUpdate]
	...
	,@EmailIsConfimed BIT = NULL
	,@PhoneIsConfimed BIT = NULL
	,@IsConfimedAdministrations BIT = NULL
	...
	BEGIN TRAN
		BEGIN TRY
			...
			UPDATE [dbo].[Users] SET 
									...
									, [Age] = ISNULL(@Age, [Age])
									, [EmailIsConfirmed] = ISNULL(@EmailIsConfimed, [EmailIsConfirmed])
									, [PhoneIsConfirmed] = ISNULL(@PhoneIsConfimed, [PhoneIsConfirmed])
									, [IsConfirmedAdministrations] = ISNULL(@IsConfimedAdministrations, [IsConfirmedAdministrations])
									WHERE [Id] = @UserId
			COMMIT
			RETURN 1
		END TRY
