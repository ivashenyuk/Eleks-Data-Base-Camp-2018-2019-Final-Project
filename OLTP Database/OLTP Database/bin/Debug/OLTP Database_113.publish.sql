...
CREATE TABLE [dbo].[Bets] (
    ...
    [CommissionOfSite]            FLOAT (53)    NOT NULL,
...
GO
PRINT N'Creating [dbo].[DF_Is_Ended_Matches]...';


GO
ALTER TABLE [dbo].[Matches]
    ADD CONSTRAINT [DF_Is_Ended_Matches] DEFAULT 0 FOR [IsEnded];
...
GO
PRINT N'Creating [dbo].[DF_Created_At_UserGroups]...';


GO
ALTER TABLE [dbo].[UserGroups]
    ADD CONSTRAINT [DF_Created_At_UserGroups] DEFAULT GETDATE() FOR [CreatedAt];
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Page_1_Passports_Photos] FOREIGN KEY ([PhotoPage1Id]) REFERENCES [dbo].[Photos] ([Id]);
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Page_2_Passports_Photos] FOREIGN KEY ([PhotoPage2Id]) REFERENCES [dbo].[Photos] ([Id]);
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Page_Registration_Passports_Photos] FOREIGN KEY ([PhotoRegistrationId]) REFERENCES [dbo].[Photos] ([Id]);
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_ID_Owner_Passports_Photos] FOREIGN KEY ([PhotoIDOwnerId]) REFERENCES [dbo].[Photos] ([Id]);
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Owner_With_Passport_Passports_Photos] FOREIGN KEY ([PhotoOwnerWithPassportId]) REFERENCES [dbo].[Photos] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Purse_Users_UserGroups]...';


GO
ALTER TABLE [dbo].[Users]
    ADD CONSTRAINT [FK_Purse_Users_UserGroups] FOREIGN KEY ([UserGroupId]) REFERENCES [dbo].[UserGroups] ([Id]);
...
GO
PRINT N'Creating [dbo].[PhotoSetNULLsForParentTable]...';
...
END
GO
PRINT N'Creating [dbo].[BankCardAdd]...';
...
END
GO
PRINT N'Creating [dbo].[BankCardGet]...';
...
END
GO
PRINT N'Creating [dbo].[BankCardRemove]...';
...
END
GO
PRINT N'Creating [dbo].[BankCardUpdate]...';
...
END
GO
PRINT N'Creating [dbo].[EventUpdateValues]...';
...
END
GO
PRINT N'Creating [dbo].[MatchRemove]...';


GO
CREATE PROCEDURE [dbo].[MatchRemove]
	@MatchId INT
AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN TRAN
		BEGIN TRY
			DELETE FROM [dbo].[Matches] WHERE [Id] = @MatchId
			COMMIT
			RETURN 1
		END TRY
		BEGIN CATCH
...
END
GO
PRINT N'Creating [dbo].[MatchUpdate]...';
...
END
GO
PRINT N'Creating [dbo].[PassportAdd]...';
...
END
GO
PRINT N'Creating [dbo].[PassportGet]...';
...
END
GO
PRINT N'Creating [dbo].[PassportRemove]...';
...
END
GO
PRINT N'Creating [dbo].[PassportUpdate]...';
...
END
GO
PRINT N'Creating [dbo].[PhotoGetCollectionPathByPassportId]...';
...
END
GO
PRINT N'Creating [dbo].[PhotoRemove]...';
...
END
GO
PRINT N'Creating [dbo].[SportRemove]...';


GO
CREATE PROCEDURE [dbo].[SportRemove]
	@SportId INT
AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN TRAN
		BEGIN TRY
			DELETE FROM [dbo].[Sports] WHERE [Id] = @SportId
			COMMIT
			RETURN 1
		END TRY
		BEGIN CATCH
...
END
GO
PRINT N'Creating [dbo].[SportUpdate]...';
...
END
GO
PRINT N'Creating [dbo].[TournamentAdd]...';
...
END
GO
PRINT N'Creating [dbo].[TournamentGet]...';
...
END
GO
PRINT N'Creating [dbo].[TournamentRemove]...';
...
END
GO
PRINT N'Creating [dbo].[TournamentUpdate]...';
