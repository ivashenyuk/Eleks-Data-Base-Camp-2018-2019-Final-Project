/*
Deployment script for OLTP Bookmaker
...
GO
:setvar DatabaseName "OLTP Bookmaker"
:setvar DefaultFilePrefix "OLTP Bookmaker"
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL14.TEST\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL14.TEST\MSSQL\DATA\"
...
CREATE TABLE [dbo].[Passports] (
    [Id]                     INT            IDENTITY (1, 1) NOT NULL,
    [PassportCode]           VARCHAR (15)   NOT NULL,
    [Seria]                  NVARCHAR (5)   NULL,
    [BirthDay]               DATE           NULL,
    [Name]                   NVARCHAR (255) NOT NULL,
    [LastName]               NVARCHAR (255) NOT NULL,
    [PhotoPage1]             INT            NOT NULL,
    [PhotoPage2]             INT            NOT NULL,
    [PhotoRegistration]      INT            NOT NULL,
    [PhotoIDOwner]           INT            NOT NULL,
    [PhotoOwnerWithPassport] INT            NOT NULL,
    [CreatedAt]              DATETIME2 (7)  NOT NULL,
    [UpdatedAt]              DATETIME2 (7)  NULL,
    [LastEditedById]         INT            NOT NULL,
...
GO
PRINT N'Creating unnamed constraint on [dbo].[BankCards]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Banks]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Bets]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Clubs]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Passports]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Purses]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Teams]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Tournaments]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Transactions]...';
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_BankCards_Users]...';


GO
ALTER TABLE [dbo].[BankCards]
    ADD CONSTRAINT [FK_Last_Edited_By_BankCards_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Banks_Users]...';


GO
ALTER TABLE [dbo].[Banks]
    ADD CONSTRAINT [FK_Last_Edited_By_Banks_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Bets_Users]...';


GO
ALTER TABLE [dbo].[Bets]
    ADD CONSTRAINT [FK_Last_Edited_By_Bets_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Clubs_Users]...';


GO
ALTER TABLE [dbo].[Clubs]
    ADD CONSTRAINT [FK_Last_Edited_By_Clubs_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Events_Users]...';


GO
ALTER TABLE [dbo].[Events]
    ADD CONSTRAINT [FK_Last_Edited_By_Events_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Locations_Users]...';


GO
ALTER TABLE [dbo].[Locations]
    ADD CONSTRAINT [FK_Last_Edited_By_Locations_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Matches_Users]...';


GO
ALTER TABLE [dbo].[Matches]
    ADD CONSTRAINT [FK_Last_Edited_By_Matches_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Organizations_Users]...';


GO
ALTER TABLE [dbo].[Organizations]
    ADD CONSTRAINT [FK_Last_Edited_By_Organizations_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Photos_Users]...';


GO
ALTER TABLE [dbo].[Photos]
    ADD CONSTRAINT [FK_Last_Edited_By_Photos_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Purses_Users]...';


GO
ALTER TABLE [dbo].[Purses]
    ADD CONSTRAINT [FK_Last_Edited_By_Purses_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Roles_Users]...';


GO
ALTER TABLE [dbo].[Roles]
    ADD CONSTRAINT [FK_Last_Edited_By_Roles_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Sports_Users]...';


GO
ALTER TABLE [dbo].[Sports]
    ADD CONSTRAINT [FK_Last_Edited_By_Sports_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Teams_Users]...';


GO
ALTER TABLE [dbo].[Teams]
    ADD CONSTRAINT [FK_Last_Edited_By_Teams_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Tournaments_Users]...';


GO
ALTER TABLE [dbo].[Tournaments]
    ADD CONSTRAINT [FK_Last_Edited_By_Tournaments_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Transactions_Users]...';


GO
ALTER TABLE [dbo].[Transactions]
    ADD CONSTRAINT [FK_Last_Edited_By_Transactions_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Last_Edited_By_Users_Users]...';


GO
ALTER TABLE [dbo].[Users]
    ADD CONSTRAINT [FK_Last_Edited_By_Users_Users] FOREIGN KEY ([LastEditedById]) REFERENCES [dbo].[Users] ([Id]);
...
GO
ALTER TABLE [dbo].[Users]
    ADD CONSTRAINT [CK_User_Age_Users] CHECK ([Age] > 18 AND [Age] < 100);
