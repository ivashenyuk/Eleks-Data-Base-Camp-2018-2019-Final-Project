...
CREATE TABLE [dbo].[tmp_ms_xx_Matches] (
    ...
    [IsEnded]        BIT           CONSTRAINT [DF_Is_Ended_Matches] DEFAULT 0 NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Matches] ([Id], [IdFromCsvFile], [IdFromJsonFile], [HomeTeamId], [AwayTeamId], [ManagerId], [LocationId], [SportId], [TournamentId], [IsStarted], [ScoreHomeTeam], [ScoreAwayTeam], [Date], [CreatedAt])
        SELECT   [Id],
                 [IdFromCsvFile],
                 [IdFromJsonFile],
                 [HomeTeamId],
