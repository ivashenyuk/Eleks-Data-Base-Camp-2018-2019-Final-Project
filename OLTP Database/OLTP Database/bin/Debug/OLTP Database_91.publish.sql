...
GO
PRINT N'Creating [dbo].[StatisticsByCardsLastTenMinutes]...';
...
CREATE TABLE [dbo].[StatisticsByCardsLastTenMinutes] (
    ...
    [CreatedAt]  DATETIME2 (7)  NOT NULL,
    CONSTRAINT [PK_StatisticsByCardsLastTenMinutes_Id] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
PRINT N'Creating [dbo].[DF_Create_At_StatisticsByCardsLastTenMinutes]...';


GO
ALTER TABLE [dbo].[StatisticsByCardsLastTenMinutes]
    ADD CONSTRAINT [DF_Create_At_StatisticsByCardsLastTenMinutes] DEFAULT GETDATE() FOR [CreatedAt];
...
BEGIN
	...
	BEGIN TRAN
		BEGIN TRY
			...
			ELSE
			BEGIN
				SELECT TOP 1 * FROM [dbo].[Matches] WHERE [Id] = @MatchId
			END
			COMMIT
		END TRY
		BEGIN CATCH
