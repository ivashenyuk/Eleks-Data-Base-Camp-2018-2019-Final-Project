...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Page_1_Passports_Photos] FOREIGN KEY ([PhotoPage1Id]) REFERENCES [dbo].[Photos] ([Id]) ON DELETE SET NULL;
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Page_2_Passports_Photos] FOREIGN KEY ([PhotoPage2Id]) REFERENCES [dbo].[Photos] ([Id]) ON DELETE SET NULL;
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Page_Registration_Passports_Photos] FOREIGN KEY ([PhotoRegistrationId]) REFERENCES [dbo].[Photos] ([Id]) ON DELETE SET NULL;
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_ID_Owner_Passports_Photos] FOREIGN KEY ([PhotoIDOwnerId]) REFERENCES [dbo].[Photos] ([Id]) ON DELETE SET NULL;
...
GO
ALTER TABLE [dbo].[Passports]
    ADD CONSTRAINT [FK_Photo_Owner_With_Passport_Passports_Photos] FOREIGN KEY ([PhotoOwnerWithPassportId]) REFERENCES [dbo].[Photos] ([Id]) ON DELETE SET NULL;
